...
import {
  ...
  Gift, PackageOpen, Target, Settings as SettingsIcon, User,
  LogOut, Bot, Menu, X, ChevronDown, ChevronRight,
  PanelLeftClose, PanelLeftOpen, HeartPulse,
} from "lucide-react"
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { href: "/customer-profile", label: "Hồ sơ khách hàng", icon: User },
    ],
  },
  {
    key: "he-thong", label: "HỆ THỐNG",
    items: [
      { href: "/system-health", label: "Kiểm tra hệ thống", icon: HeartPulse },
